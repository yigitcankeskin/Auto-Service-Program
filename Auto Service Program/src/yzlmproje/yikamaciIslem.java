 ...
 * @author yc_ke
 */
public class yikamaciIslem extends javax.swing.JFrame {
  DefaultTableModel dtm =new DefaultTableModel();

    /**
     * Creates new form yikamaciIslem
     */
    static String yıkamacı_id,ad_soyad,maas,mesai_saati,is_durumu;
    public yikamaciIslem() {
        initComponents();
         dtm.setColumnIdentifiers(new String[]{"yıkamacı_id","ad_soyad","maas","mesai_saati","is_durumu"});
	...
	Connection con = DriverManager.getConnection(url, user, password);
        ...
        while(rs.next()){
         dtm.addRow(new String[]{Integer.toString(rs.getInt("yıkamacı_id")),rs.getString("ad_soyad"),
    ...
    private void initComponents() {
        ...
        txtyikamaciıd = new javax.swing.JTextField();
        ...
        txtyikamaciıd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtyikamaciıdActionPerformed(evt);
            }
        });
        ...
        jLabel1.setText("Yıkamacı Düzenleme İşlemleri");
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(txtyikamaciıd, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txtyikamaciıd, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGap(436, 436, 436)
                    .addComponent(btntblo)
    ...
    private void txtyikamaciıdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtyikamaciıdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtyikamaciıdActionPerformed
    ...
    private void btnguncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguncelleActionPerformed
        ...
        try{
            ...
            String q = "UPDATE Yikamaci SET ad_soyad='"+ad_soyad+"',maas='"+maas+"'" + ",mesai_saati='"+mesai_saati+"',is_durumu='"+is_durumu+"' where yıkamacı_id='"+yıkamacı_id+"'";
            int sonuc = stm.executeUpdate(q);
            if(sonuc==1){
    ...
    private void btnolusturActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnolusturActionPerformed
        ...
        try{
            ...
            mesai_saati =  txtmesai.getText();
            is_durumu =  txtis.getText();
            String q = "INSERT INTO Yikamaci (ad_soyad,maas,mesai_saati,is_durumu) VALUES ('"+ad_soyad+"','"+maas+"','"+mesai_saati+"','"+is_durumu+"')";
            int sonuc = stm.executeUpdate(q);
            if(sonuc==1){
    ...
    private void btnbulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbulActionPerformed
        ...
        try{
            ...
            String password = "sifre123";
            Connection con = DriverManager.getConnection(url, user, password);
            String Id=txtyikamaciıd.getText();

            Statement stm = con.createStatement();
            String sql = "select *  from Yikamaci where yıkamacı_id='"+Id+"' ";
            ResultSet rs = stm.executeQuery(sql);
            while(rs.next()){

                yıkamacı_id=Integer.toString(rs.getInt("yıkamacı_id"));
            ...
            btnreset.doClick();
            txtyikamaciıd.setText(yıkamacı_id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(yikamaciIslem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new yikamaciIslem().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtyikamaciıd;
